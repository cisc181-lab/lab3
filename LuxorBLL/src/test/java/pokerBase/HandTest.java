...
public class HandTest {
	...
	public void TestHandSortTons() {
		...
		/*
		 * Create a thousand random hands... I want to see if the sort /
		 * comparator for hand works.
		 */
	...
	public void TestPickBestHand() {
		...
		boolean expectedCaughtException = true;
		boolean actualCaughtException = false;
		...
		try {
			Hand bestHand = Hand.PickBestHand(hands);
		} catch (exHands e) {
			actualCaughtException = true;
		}
		assertTrue(actualCaughtException == expectedCaughtException);

	}

	@Test
	public void TestPickBestHand2() {
		Hand bestHand = null;
		boolean expectedCaughtException = true;
		boolean actualCaughtException = false;
